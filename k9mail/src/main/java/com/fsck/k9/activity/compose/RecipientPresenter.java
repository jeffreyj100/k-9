...
public class RecipientPresenter implements PermissionPingCallback {
    ...
    public void initFromDraftMessage(LocalMessage message) {
        ...
        initOpenPgpCompatFromDraftMessage(message);
    }
    ...
    private void initOpenPgpCompatFromDraftMessage(LocalMessage message) {
        cryptoEnableCompat = message.isSet(Flag.X_DRAFT_OPENPGP_INLINE);
    }
